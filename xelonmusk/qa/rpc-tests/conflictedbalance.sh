...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars XELONMUSKD and XELONMUSKCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

XELONMUSKD=${XELONMUSKD:-${1}/xelonmuskd}
CLI=${XELONMUSKCLI:-${1}/xelonmusk-cli}
