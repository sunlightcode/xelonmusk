...
from test_framework import XElonMuskTestFramework
...
class TxnMallTest(XElonMuskTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 XELON:
        ...
        # First: use raw transaction API to send 1210 XELON to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50STC for another
        ...
        # Node0's total balance should be starting balance, plus 100STC for 
