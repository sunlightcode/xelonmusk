...
###Examples
Create the original genesis hash found in XElonMusk
...
Create the original genesis hash found in DarkCoin. (requires [xcoin-hash](https://github.com/lhartikk/xcoin-hash))
    ...
    python genesis.py -a X11 -z "Wired 09/Jan/2014 The Grand Experiment Goes Live: Overstock.com Is Now Accepting XElonMusks" -t 1317972665 -p "040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9" -n 28917698 -t 1390095618 -v 5000000000
...
###Options
    ...
    Options:
      ...
      -v VALUE, --value=VALUE
         the value in coins for the output, full value (exp. in xelonmusk 5000000000 - To get other coins value: Block Value * 100000000)
