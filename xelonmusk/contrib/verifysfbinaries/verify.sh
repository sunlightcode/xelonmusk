...
###   This script attempts to download the signature file SHA256SUMS.asc from xelonmusk.org
...
WORKINGDIR="/tmp/xelonmusk"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://xelonmusk.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://xelonmusk.org/bin/"
VERSIONPREFIX="xelonmusk-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'xelonmusk-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[xelonmusk-]<version>-[rc[0-9]] (example: xelonmusk-0.9.2-rc1)"
   echo "wget output:"
