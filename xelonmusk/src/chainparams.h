...
#ifndef XELONMUSK_CHAINPARAMS_H
#define XELONMUSK_CHAINPARAMS_H
 ...
 * XElonMusk system. There are three: the main network on which people trade goods
...
public:
    ...
    /** Used if GenerateXElonMusks is called with a negative number of threads */
...
protected:
    ...
    int64_t nSubsidyHalvingInterval;
