...
#ifndef XELONMUSK_RPCPROTOCOL_H
#define XELONMUSK_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! XElonMusk is not connected
