...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CXElonMuskAddress demoAddress = CXElonMuskAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CXElonMuskAddress setaccountDemoAddress = CXElonMuskAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CXElonMuskAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CXElonMuskAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
