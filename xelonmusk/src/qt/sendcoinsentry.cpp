    ...
    model(0)
{
    ...
    // normal xelonmusk address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying xelonmusk address(es)
    ui->payTo_is->setFont(GUIUtil::xelonmuskAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // just for hide messageTextLabel
