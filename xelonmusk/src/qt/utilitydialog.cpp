    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("XElonMusk Core") + " " + tr("version") + " " + "v1.0";// QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About XElonMusk Core"));
        ...
        cursor.insertText(tr("Usage:") + '\n' +
            "  xelonmusk-qt [" + tr("command-line options") + "]\n");
        ...
        QString coreOptions = QString::fromStdString(HelpMessage(HMM_XELONMUSK_QT));
        bool first = true;
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("XElonMusk Core is shutting down...") + "<br /><br />" +
        tr("Do not shut down the computer until this window disappears.")));
    setLayout(layout);
}

void ShutdownWindow::showShutdownWindow(XElonMuskGUI *window)
{
    if (!window)
        return;
