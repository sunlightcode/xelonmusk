...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(SingleColorIcon(":icons/xelonmusk"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("XElonMusk Core"),
     ...
     * override -datadir in the xelonmusk.conf file in the default data directory
     * (to be consistent with xelonmuskd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
