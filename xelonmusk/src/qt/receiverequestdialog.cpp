...
#include "config/xelonmusk-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatXElonMuskURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + XElonMuskUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatXElonMuskURI(info));
}
