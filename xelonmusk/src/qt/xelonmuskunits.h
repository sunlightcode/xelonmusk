...
#ifndef XELONMUSK_QT_XELONMUSKUNITS_H
#define XELONMUSK_QT_XELONMUSKUNITS_H
...
/** XElonMusk unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class XElonMuskUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit XElonMuskUnits(QObject *parent);

    /** XElonMusk units.
      @note Source: https://en.xelonmusk.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XELON,
...
typedef XElonMuskUnits::Unit XElonMuskUnit;

#endif // XELONMUSK_QT_XELONMUSKUNITS_H
