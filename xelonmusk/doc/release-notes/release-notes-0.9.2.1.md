XElonMusk Core version 0.9.2.1 is now available from:

  https://xelonmusk.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 XELON to 0.01 XELON
...
- Fix "Start xelonmusk on system login"
